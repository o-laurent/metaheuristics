...
def best(best, **kwargs):
    """"""
    def f(val, best_val, temperature):
        return best(val, best_val, temperature, **kwargs)
    return f


def replacement(replacement, **kwargs):
    """"""
    def f(ind_iter):
        return replacement(ind_iter, **kwargs)
    return f


def selection(selection, **kwargs):
    """"""
    def f(val, best_val, temperature):
        return selection(val, best_val, temperature, **kwargs)
    return f
...
def variation(variation, **kwargs):
    """"""
    def f(ind_iter):
        return variation(ind_iter, **kwargs)
    return f
